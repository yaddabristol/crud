...
abstract class CrudController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if (view()->exists($this->views_dir . '.index')) {
                ...
                return view('vendor.crud.index', compact('items'));
            }
        }
    }
    ...
    public function create()
    {
        ...
        if (view()->exists($this->views_dir . '.create')) {
            return view($this->views_dir . '.create', compact('items'));
        } else {
            return view('vendor.crud.create', compact('items'));
        }
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            ...
            if (view()->exists($this->views_dir . '.show')) {
                return view($this->views_dir . '.show', compact('items'));
            } else {
                return view('vendor.crud.show', compact('items'));
            }            
        }
    }
    ...
    public function edit($id)
    {
        ...
        if (view()->exists($this->views_dir . '.edit')) {
            ...
            return view('vendor.crud.edit', compact('item'));
        }
    }
